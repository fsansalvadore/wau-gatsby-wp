...
const HomePageLayout = ({ lang, data, ...otherProps }) => {
  ...
  useEffect(() => {
    if(typeof window !== `undefined` && typeof document !== `undefined` && !!acf) {
            ...
            <StyledIntroContainer
              ...
              >
                ...
                <div
                  ...
                  >
                  <p>{acf.testoDentroSfera ? acf.testoDentroSfera : "SCOPRI L’EFFETTO WAU"}</p>
                </div>
                <div
              ...
              >
                ...
                <GridMaxWidthContainer>
                  <SectionTextBlock
                    ...
                    title={acf.sezioneVision.titolo ? acf.sezioneVision.titolo : ""}
                    content={acf.sezioneVision.paragrafo ? acf.sezioneVision.paragrafo : ""}
                    link={!!acf.sezioneVision.tasto.link && acf.sezioneVision.tasto.link}
